...
def process_image(msg):
    try:
       # convert sensor_msgs/Image to OpenCV Image
        ...
        pumpCircles = cv2.HoughCircles(thresh, cv2.HOUGH_GRADIENT, 1, PUMP_DIAMETER, param2=3, minRadius=pumpRadiusRange[0], maxRadius=pumpRadiusRange[1])
        ...
        #fit a bounding box to the largest contour
